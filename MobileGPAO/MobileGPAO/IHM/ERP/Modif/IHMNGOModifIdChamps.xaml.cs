...
namespace GPAOnGo.IHM.ERP
{
    ...
    public partial class IHMNGOModifIdChamps : ContentPage
    {
        NGOPage oObjectERP;

        public IHMNGOModifIdChamps()
        {
        ...
        protected override void OnAppearing()
        {
            ...
            //colonneComboBox.ComboBoxSource = l2;
            //oObjectERP.Vues_liste.RemoveAt(0);

        }

        private void ValueChangeColonne(object sender, EventArgs e)
        {
            //App.crea.setColonne(colonneComboBox.Text);
        }
    }
}