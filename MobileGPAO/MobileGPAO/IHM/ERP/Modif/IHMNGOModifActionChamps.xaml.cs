...
namespace GPAOnGo.IHM.ERP
{
    ...
    public partial class IHMNGOModifActionChamps : ContentPage
    {
        NGOPage oObjectERP;

        public IHMNGOModifActionChamps()
        {
        ...
        protected override void OnAppearing()
        {
            ...
            //actionComboBox.ComboBoxSource = l2;
        ...
        {
            App.crea.setFonction(actionComboBox.Text);
        }*/
    }
}